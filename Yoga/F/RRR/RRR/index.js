document.addEventListener('DOMContentLoaded', () => {
    ...
    gsap.from(".main-title", { opacity: 0, y: 50, duration: 1.5, ease: "power2.out", scrollTrigger: { trigger: ".Physiotherapy-section", start: "top 80%" } });

    // Particle canvas setup for about and Physiotherapy sections
    const canvases = [
