    ...
    <div class="wrapper">
        ...
        <div class="main p-3">
            <div class="text-center">
                <h2 class="text-center mb-2">Complain Track</h2>
                <hr>
                <form action="" method="post" id="sheetdb-form">
                    <div class="mb-3 mt-5"> 
                        <div class="input-btn d-flex  justify-content-center col-6 mx-auto">
                            <input type="text" class="form-control" id="track_circuit_id" name="" placeholder="Circuit Id">
                            <button type="button" id="Circuit_Search" class="btn btn-outline-secondary ms-2">
                                <i class="fa fa-search"></i>
                            </button>
                        </div>
                        <small class="mt-2 text-muted d-block text-center">OR</small>
                    </div>
    
                    <div class="mb-3">
                        <div class="input-btn d-flex  justify-content-center col-6 mx-auto">
                            <input type="text" class="form-control" id="track_id" name="" placeholder="Complain Id">
                            <button type="button" id="Complain_Search" class="btn btn-outline-secondary ms-2">
                                <i class="fa fa-search"></i>
                            </button>
                        </div>
                    </div>
    
                    <div class="mt-4 d-flex  justify-content-center col-6 mx-auto justify-content-around ">
                    ...
                    <h6 id="trackmessage" class="text-danger mt-3">Tracking Message Here...</h6>
                </form>
            </div>
        </div>
</body>
...
<script src="../Js/Complain_Tracks.js"></script>
