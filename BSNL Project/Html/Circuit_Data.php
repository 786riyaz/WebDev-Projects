    ...
    <div class="wrapper">
        <aside id="sidebar" class="expand">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="Circuit_Data.php" class="sidebar-link">
                        <i class="lni lni-agenda"></i>
                        <span>Data</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="complain_booking_new.php" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="auth" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                      <li class="sidebar-item">
                        <a href="Complain_Pending_bsnl_menu.php" class="sidebar-link">Bsnl Pending</a>
                    </li> 
                      <li class="sidebar-item">
                            <a href="Complain_Pending.php" class="sidebar-link">Pending</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="Complain_Complete.php" class="sidebar-link">Complete</a>
                        </li>
                    </ul>
                </li>
                <li class="sidebar-item">
            ...
            <div class="text-center">
                <h1>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <button class="btn btn-outline-success me-md-2" type="button" id="addbutton">Add</button>
                      ...
                      <!-- <form class="row g-4" id="add-button" > -->
                        ...
                        <div class="col-12">
                            ...
                            <button type="button" class="btn btn-dark" id="addDetailshide">Close</button> <!-- Changed from submit to button -->
                        </div>
                        <hr>
                    <!-- </form> -->
                </div>
