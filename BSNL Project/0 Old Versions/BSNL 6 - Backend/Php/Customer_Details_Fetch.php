...
if (true) {
    ...
    if ($conn->connect_error) {
        ...
        $stmt = "SELECT CD.TelephoneNumber, CD.Service, CD.Name, CD.MobileNumber, CD.Address ,C.Is_Resolved, C.Complain_ID FROM CustomerDetails CD LEFT JOIN Complain C ON C.Telephone_Number = CD.TelephoneNumber WHERE CD.TelephoneNumber = '" . $_GET['telephoneNumber'] . "'";
