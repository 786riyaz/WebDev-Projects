...
if (true) {
    ...
    if ($conn->connect_error) {
        ...
        $stmt = "SELECT CD.Exchange, CD.Circuit_ID, CD.Name, CD.Address_A, CD.Address_B,CD.Contect,CD.Connectivity,CD.Cable_Lenght ,C.Is_Resolved, C.complain_id FROM circuitdetails CD LEFT JOIN complain C ON C.circuit_id = CD.circuit_id WHERE CD.circuit_id = '" . $_GET['circuit_id'] . "' AND (C.Is_Resolved = '0' OR C.Is_Resolved = '2')" ;
